...
import { Tag, Table, Icon, Modal } from "antd";
import { Fragment, useEffect, useState } from "react";
import Adjust from "./adjust";

export default (props) => {

  const { refundList ,getStatResult } = props;
  ...
  },
  {
    ...
    render: (value) => showOrderStatus(value)
  }, {
    title: '退费订单号',
    dataIndex: 'refundId',
    render: (text, record) => record.payOrRefund === 1 ? '-' : text
  }, {
    title: '收费/退费',
    ...
    title: '当日/跨天退款',
    dataIndex: 'isCurrentDayRefund',
    render: value => {
      return value ? ( value == '1' ? '当日退款' : '跨天退款') : '未知'
    }
  }, {
    title: '操作',
    dataIndex: 'adjust',
