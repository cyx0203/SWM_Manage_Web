...
import FormCol from "./Col";



const SpecialForm: any  = forwardRef((props: any,ref: any) => {
  const {
    formLayout,
    formItemLayout,
    onSubmit,
  ...
  <Row gutter={8}>
    {
      fields && fields.map((item)=>{
        ...
        if(formLayout === 'inline' && item.colSpan > 1){
          ...
          return <FormCol cols={cols} item={item} formItemLayout={item.itemLayout||formItemLayout2} layout={formLayout} addFormFields={addFormFields} subFormFields={subFormFields}/>
        } 
        return <FormCol cols={cols} item={item} layout={formLayout} formItemLayout={formItemLayout1} addFormFields={addFormFields} subFormFields={subFormFields}/>
