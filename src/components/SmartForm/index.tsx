    ...
    <Row gutter={8}>
      {
        fields && fields.map((item,i) => {
          ...
          if (formLayout === 'inline' && item.colSpan > 1) {
            ...
            return <FormCol key={i} cols={cols} item={item} formItemLayout={item.itemLayout || formItemLayout2} layout={formLayout} />
          }
          return <FormCol key={i} cols={cols} item={item} layout={formLayout} formItemLayout={formItemLayout1} />
        })
      }
    </Row>
    {
